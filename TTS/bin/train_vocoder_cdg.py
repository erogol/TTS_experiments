...
from TTS.utils.cgd_optim.acgd import ACGD
...
def main(args):  # pylint: disable=redefined-outer-name
    ...
    #                        lr=c.lr_disc,
    #                        weight_decay=0)
    optimizer_disc = ACGD(max_params=model_gen.parameters(), min_params=model_disc.parameters(), lr_max==c.lr_disc, lr_min==c.lr_discr)
