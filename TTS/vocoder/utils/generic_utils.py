...
def setup_generator(c):
    ...
    if c.generator_model in 'parallel_wavegan_generator':
        model = MyModel(
            ...
            res_channels=c.generator_model_params['res_channels'] or 64,
            gate_channels=c.generator_model_params['gate_channels'] or 128,
            skip_channels=c.generator_model_params['skip_channels'] or 64,
